...
export default function ProviderSetupGuide({ isOpen, onClose, provider }: Props) {
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div
        className="fixed inset-0 z-[9991] flex items-center 
        justify-center p-4"
      >
        <div
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-bold text-[#1A1A1A]">
              {provider === 'ollama' ? '🦙 Set up Local AI' : '🔑 Set up API Key'}
            </h2>
            <button
              type="button"
              onClick={onClose}
            ...
            <div className="space-y-3 text-sm text-gray-600">
              ...
              <ol className="list-decimal pl-4 space-y-2">
                ...
                <li>
                  Run in terminal:
                  <code
                    className="block bg-gray-900 text-green-400 
