  ...
  const handleGenerateBrief = async (
    ...
    setTimeout(() => {
      ...
      if (briefId) {
        ...
        alert(
          'Could not generate AI strategy brief. Ensure database and API connections are valid.'
        )
      }
    }, remaining)
  }
    ...
    <div className="space-y-6">
      ...
      {filteredTrends.length === 0 ? (
        <div className="border border-gray-200 rounded-2xl p-12 text-center bg-white space-y-4 shadow-card">
          <div className="text-gray-500 font-semibold text-sm uppercase">
            No active trends found for this niche
          </div>
          <button
            onClick={handleReseed}
