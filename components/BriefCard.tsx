  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 flex flex-wrap justify-between items-center gap-4 shadow-card">
        <div>
          <span className="text-[10px] font-bold text-[#FF6B4A] uppercase tracking-wider block mb-1">
            Active Predictor Dossier
          </span>
        ...
        <div className="flex items-center space-x-4 sm:border-l sm:border-gray-150 sm:pl-4">
          <div className="text-right">
            ...
            <div className="text-lg font-black text-[#1A1A1A]">
              {formatIndianNumber(trend.velocity_score)}%
            </div>
          </div>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {brief.angles.map((angle, index) => (
            <div
              key={index}
              className="bg-white border border-gray-200 rounded-2xl p-5 flex flex-col justify-between shadow-card hover:shadow-md transition-all duration-200"
            >
              <div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-5 flex items-center space-x-4 shadow-card">
        ...
        <div>
          ...
          <div className="text-sm font-bold text-[#1A1A1A] font-mono uppercase mt-0.5">
            {brief.format}
          </div>
        ...
        <div className="relative pl-6 border-l border-orange-100 space-y-6 py-2">
          ...
          <div className="relative">
            ...
            <p className="text-xs text-gray-655 mt-1 leading-relaxed">
              Open directly with the scroll-stopping hook:{' '}
              <span className="italic text-gray-800 font-semibold">&ldquo;{brief.hook}&rdquo;</span>
              . Maintain eye contact, use bold styling overlay.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <p className="text-xs text-gray-655 mt-1 leading-relaxed">
              Pivot to visual angle structures. Present the core value vector, showing overlays or
              POV screens while detailing the setup, hack, or comparison.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="flex justify-between items-baseline gap-4">
              <h5 className="text-xs font-bold text-[#1A1A1A] uppercase tracking-wider">
                Act 3: Payoff & Call-To-Action
              </h5>
              <span className="text-[11px] font-mono text-[#FF6B4A] font-bold">20s - 30s</span>
            </div>
            <p className="text-xs text-gray-655 mt-1 leading-relaxed">
              Deliver the ultimate payoff resolution. Conclude with a strong, prompt call to action
              to save this video and follow for more trend blueprints.
            </p>
          </div>
        </div>
      </div>
